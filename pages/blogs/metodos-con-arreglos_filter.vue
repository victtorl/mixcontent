    ...
    <div class="max-w-3xl mx-auto">
        <div
            ...
            <div class="">
                ...
                <h1 href="#" class="text-gray-900 font-bold text-4xl">Métodos con arreglos en JS (FILTER)</h1>
	...
	<g>
		<path d="M256,0C114.837,0,0,114.837,0,256s114.837,256,256,256s256-114.837,256-256S397.163,0,256,0z M277.333,256
			c0,11.797-9.536,21.333-21.333,21.333h-85.333c-11.797,0-21.333-9.536-21.333-21.333s9.536-21.333,21.333-21.333h64v-128
                ...
                <h3 class="text-2xl font-bold my-5"> FILTER</h3>
                <blockquote class="text-md italic leading-8 my-5 p-5 text-indigo-600 font-semibold">
                    crea un arreglo con los elementos que cumplen con una condición dada 
                </blockquote>
