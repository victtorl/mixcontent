    ...
    <div class="relative max-w-7xl mx-auto">
        <div class="max-w-lg mx-auto rounded-lg shadow-lg overflow-hidden lg:max-w-none lg:flex">
            <div class="flex-1 px-6 py-8 lg:p-12 bg-gray-600">
                <h3 class="text-2xl font-extrabold text-white sm:text-3xl">Lifetime access</h3>
                <p class="mt-6 text-base text-gray-50 sm:text-lg">Take your Tailwind CSS development to the next level!
                </p>
                <div class="mt-8">
